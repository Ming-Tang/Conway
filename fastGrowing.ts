 ...
 */
export const wainer = (ord: Real | Conway, n: bigint): bigint => {
	if (isZero(ord)) {
		return n + 1n;
	}
	if (isLimit(ord)) {
 ...
 * @returns The result in `bigint`
 */
export const hardy = (ord: Real | Conway, n: bigint): bigint => {
 ...
 * @returns The result in `bigint`
 */
export const slow = (ord: Real | Conway, n: bigint): bigint => {
